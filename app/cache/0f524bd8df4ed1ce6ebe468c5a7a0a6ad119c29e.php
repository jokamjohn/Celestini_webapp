        ...
        <div class="panel-body">
            ...
            <table class="table table-striped">
                ...
                <?php foreach($details as $detail): ?>
                    <tr>
                        <td><?php echo e($detail->get(\app\Constant::$KEY_FIRST_NAME)); ?></td>
                        <td><?php echo e($detail->get(\app\Constant::$KEY_LAST_NAME)); ?></td>
                        <td><?php echo e($detail->get("Village")); ?></td>
                        <td><?php echo e($detail->get(\app\Constant::$KEY_DISTRICT)); ?></td>
                        <?php if($detail->get(\app\Constant::$KEY_DATE_OF_BIRTH) != null): ?>
                        <td><?php echo e(formatDate($detail->get(\app\Constant::$KEY_DATE_OF_BIRTH))); ?></td>
                            <?php endif; ?>
                    </tr>
                <?php endforeach; ?>
            </table>
