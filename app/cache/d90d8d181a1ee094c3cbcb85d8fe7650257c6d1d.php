<?php $__env->startSection("content"); ?>
    ...
    <div id="homepage_carousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="<?php echo e(assets("/images/Untitled-2.svg")); ?>" class="img-responsive" height="580px" width="auto"
                     alt="...">
            ...
            <div class="item">
                <img src="<?php echo e(assets("/images/analytics-011.svg")); ?>" class="img-responsive" height="580px" width="auto"
                     alt="...">
                <!--<div class="carousel-caption">-->
                <!--<h3>Second Image</h3>-->
                <!--<p>This is text associated with this image</p>-->
            ...
            <div class="item">
                <img src="<?php echo e(assets("/images/monitoring-01.svg")); ?>" class="img-responsive" height="580px" width="auto"
                     alt="...">
                <!--<div class="carousel-caption">-->
                <!--<h3>Third Image</h3>-->
                <!--<p>This is text associated with this image</p>-->
    ...
    <div id="features_container" class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-3">
                <div class="row"><img src="<?php echo e(assets("/images/11918-NOAAJY.jpg")); ?>"
            ...
            <div class="col-xs-1"></div>
            <div class="col-xs-3">
                <div class="row"><img src="<?php echo e(assets("/images/11918-NOAAJY.jpg")); ?>" style="height: auto; width: 80%"
                                      class="img-circle vector-background" alt=""></div>
                <div class="row">
